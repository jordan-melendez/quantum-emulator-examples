...
\begin{figure}
\vspace{-0.4cm}
\includegraphics[width=0.9\textwidth]{figures/bound_state_error_emulator.png}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}
\vspace{-0.4cm}
\includegraphics[width=\textwidth]{figures/tan_delta_UQ_minnesota.png}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}
\vspace{-0.4cm}
\includegraphics[width=\textwidth]{figures/galerkin_poisson_potential.png}
\end{figure}
\end{column}
\end{columns}
\end{frame}
